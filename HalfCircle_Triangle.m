...
mesh = generateMesh(model, 'GeometricOrder', 'linear', 'Hmax',0.1,'Hmin',0.05);
pdeplot(model);
...
writematrix(Nodes,'HCTmesh_Nodes.txt','Delimiter','space');
writematrix(Elements,'HCTmesh_Elements.txt','Delimiter','space');
writematrix(InnerBEdges,'HCTmesh_InnerEdges.txt','Delimiter','space');
writematrix(OuterBEdges,'HCTmesh_OuterEdges.txt','Delimiter','space');
