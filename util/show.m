...
function show( sol, name, elements3, coordinates, varargin )
    ...
    if (nargin==4)
        ...
        sgtitle( {name, join([num2str(100*varargin{2}), "% O_{2}, ", num2str(100*varargin{3}), "% CO_{2}" " at ", num2str(varargin{1}), "°C"])}, 'FontSize', 20 )
    end
end